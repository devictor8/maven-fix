...
public class ResultadoMegasena {
    ...
    private final static String URL = "http://www.caixa.gov.br/_newincludes/home_2011/resultado_megasena.asp";
    ...
    public static String[] obtemUltimoResultado() {
        ...
        try {
            ...
            // Destruição do cliente para liberação dos recursos do
            sistema.httpclient.getConnectionManager().shutdown();
        }
    }
